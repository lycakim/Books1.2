    ...
    <div class="col-12 col-xl-12 stretch-card">
      <div class="row flex-grow-1">
        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <img
              src="{{ !empty($data->cover_image) ? url('upload/cover_images/'.$data->cover_image) : url('upload/placeholder.jpg') }}"
              class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">{{$data->book_name}}</h5>
              <div class="text-justify"
                style="max-width: 220px;  overflow: hidden;  display: -webkit-box; -webkit-line-clamp: 3; line-clamp: 3; -webkit-box-orient: vertical;">
                <p class="card-text">{{$data->book_desc}}.</p>
              </div>
              @if($data->allowed_users != null)
              <div class="mt-2 mb-2">
                <p class="card-text text-muted"> <small class="text-muted">Shared to:
                    <span class="fw-bold">{{ App\Models\User::getName($data->allowed_users)}}</span></small></p>
              </div>
              @endif
