            ...
            <div class="mt-3">
              <div class="d-flex align-items-center">
                <img class="img-xs rounded-circle"
                  ...
                  alt="">
                <div class="ms-2">
                  <h6 class="card-title mb-0">{{$profileData->username}}</h6>
                  <!-- <p class="fw-bolder">Mike Popescu</p> -->
              ...
              <form class="forms-sample" method="POST" action="{{ route('user.update.password')}}">
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control @error('old_password') is-invalid @enderror"
                    id="old_password" autocomplete="off" name="old_password" placeholder="Password">
                  @error('old_password')
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control @error('new_password') is-invalid @enderror"
                    id="new_password" autocomplete="off" name="new_password" placeholder="Password">
                  @error('new_password')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                </div>
